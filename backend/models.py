...
class Inquilino(Base):
    ...
    rg = Column(BigInteger, unique=True, nullable=False)
    cpf = Column(BigInteger, unique=True, nullable=False)
    mae = Column(Text, nullable=False)
    automovel = Column(Text, nullable=False)
    modelo_auto = Column(Text, nullable=False)
    placa_auto = Column(Text, nullable=False)
    cor_auto = Column(Text, nullable=False)
    checkin = Column(Date(), nullable=False)
    checkout = Column(Date(), nullable=False)
