...
with tab1:
    ...
    uploaded_ficha = st.file_uploader(
                ...
                if st.button('Registrar', key= 61005):
                    for i, r in df.iterrows():
                        ficha_data = {
                            ...
                            'proprietario': None,
                            'imob_fone': None,
                            'a0': {'nome': df.a0_nome[i], 'doc': df.a0_doc[i], 'idade': df.a0_idade[i], 'parentesco': df.a0_parentesco[i]},
                            'a1': {'nome': df.a1_nome[i], 'doc': df.a1_doc[i], 'idade': df.a1_idade[i], 'parentesco': df.a1_parentesco[i]},
                            'a2': {'nome': df.a2_nome[i], 'doc': df.a2_doc[i], 'idade': df.a2_idade[i], 'parentesco': df.a2_parentesco[i]},
                            'a3': {'nome': df.a3_nome[i], 'doc': df.a3_doc[i], 'idade': df.a3_idade[i], 'parentesco': df.a3_parentesco[i]},
                            'a4': {'nome': df.a4_nome[i], 'doc': df.a4_doc[i], 'idade': df.a4_idade[i], 'parentesco': df.a4_parentesco[i]},
                            'a5': {'nome': df.a5_nome[i], 'doc': df.a5_doc[i], 'idade': df.a5_idade[i], 'parentesco': df.a5_parentesco[i]},
                            'a6': {'nome': df.a6_nome[i], 'doc': df.a6_doc[i], 'idade': df.a6_idade[i], 'parentesco': df.a6_parentesco[i]},
                            'a7': {'nome': df.a7_nome[i], 'doc': df.a7_doc[i], 'idade': df.a7_idade[i], 'parentesco': df.a7_parentesco[i]},
                            'a8': {'nome': df.a8_nome[i], 'doc': df.a8_doc[i], 'idade': df.a8_idade[i], 'parentesco': df.a8_parentesco[i]},
                            'a9': {'nome': df.a9_nome[i], 'doc': df.a9_doc[i], 'idade': df.a9_idade[i], 'parentesco': df.a9_parentesco[i]}
                        }
