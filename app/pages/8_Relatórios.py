...
if apto:
    ...
    pagamentos = requests.get("http://api:8000/pagamentos/")
    ...
    despesas = requests.get("http://api:8000/despesas/")
    if despesas.status_code == 200:
        ...
        df_desp = df_desp.drop(["apto_id", "id", "criado_em", "modificado_em"], axis=1)
    ...
    alugueis = requests.get("http://api:8000/alugueis/")
    if alugueis.status_code == 200:
        ...
        df_alug = df_alug.drop(
            ["apto_id", "ficha", "nome", "contato", "id", "criado_em", "modificado_em"],
            axis=1,
        )
        alug_ord = [
            "checkin",
